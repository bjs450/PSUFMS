...
#include "Qt.h"
#include "FilesSet.h"
//#include "/home/branden/testing/fmsu/myRootClass/G4QT.h"
...
// I/O INFORMATION
  ...
  G4long seed = (time(NULL)) + eventNumber*10000000.; //BS. Moved this here and added event number to not get multiple events with same seed initially. Weight on eventNumber prevents coindental overlap of timings seconds apart
  CLHEP::HepRandom::setTheSeed(seed);
...
//BS. NOTE: Currently I'm having issues with this. I think that Heprap visualization could work, however it has issues with OpenJDK. May neeed to use JAVA Oracle JDK
  ...
  if (argc!=1)   // batch mode  
  {
    ...
    if(fileName == "/home/branden/testing/fmsu/simgen/outgen/pythiaout.root")
    {

...
class EventLoop : public TObject
{
  public:
    ...
    Double_t etamincuts, etamaxcuts, ptmincuts, ptmaxcuts,Emincuts,Emaxcuts, phimincuts, phimaxcuts; //Used for cuts
    Double_t xHitmin, xHitmax, yHitmin, yHitmax; //BS. maximum x/y positions when it gets to 6.7 m. 
    Double_t xHit, yHit;  //acutal x/y positions at 6.7m
    ...
    Bool_t JPsiAnalysis, Pi0Analysis, JustTriggeredPi0, Only1Pi0, UseMinBiasPi0;
    ofstream myfile;
    TString outstring;
